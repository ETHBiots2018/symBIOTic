...
//    String wallet = Environment.getDataDirectory().getAbsolutePath()+"/wallet.json";
    String wallet = "/storage/emulated/0/wallet.json";
...
//        String clientVersion = web3ClientVersion.getWeb3ClientVersion();
    ...
    public int getBalance(String address){
        int balance = 0;
        try {
             RemoteCall<BigInteger> bal = contract.getBalance(address);
             BigInteger bi  =  bal.send();
             balance = bi.intValue();
        } catch (Exception e) {
            e.printStackTrace();
        }
